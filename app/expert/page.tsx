          ...
          <div className='lg:w-[70%]'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[1rem] mt-[1rem]'>
              {usersData.map((user, index) => (
                <div
                  key={index}
                  className='rounded-b-md shadow-md border-t-2 border-amber-400 w-full text-[var(--text-primary)] dark:bg-slate-800'
                >
                  <div className='p-2 flex flex-col lg:flex-row items-end'>
                    <Image
                      src={user.image}
                      alt='avatar'
                      width={50}
          ...
          <div className='lg:w-[30%]'>
            ...
            {usersData.map((user, index) => (
              <div className='my-4 flex flex-col gap-y-4' key={index}>
                <div className='rounded-r-md shadow-md border-l-2 border-amber-400 dark:bg-slate-800'>
