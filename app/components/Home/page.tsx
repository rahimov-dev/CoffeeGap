					...
					<div className="flex justify-between my-4 gap-x-8">
						<div className="rounded-md shadow-md border-t-2 border-sky-500 w-[32%]">
							<div className="border-b p-2 flex items-end">
								...
								<div className="ml-4 tracking-wider">
									<h2 className="text-gray-600 text-lg font-semibold">John</h2>
							...
							<div className="px-4 pb-4 mt-4 tracking-wider">
								...
								<p className="h-[18vh] text-sky-900 text-sm py-1">
									...
									eligendi sed nesciunt rem similique iure. Id animi enim iste
									ducimus magni! Modi culpa provident ullam, quaerat accusamus
									cupiditate?
								</p>
						...
						<div className="rounded-md shadow-md border-t-2 border-sky-500 w-[32%]">
							<div className="border-b p-2 flex items-end">
								...
								<div className="ml-4 tracking-wider">
									<h2 className="text-gray-600 text-lg font-semibold">Anna</h2>
									<span className="text-gray-500 text-sm">
										last seen at 13:01
									</span>
								</div>
						...
						<div className="rounded-md shadow-md border-t-2 border-sky-500 w-[32%]">
							<div className="border-b p-2 flex items-end">
								...
								<div className="ml-4 tracking-wider">
									<h2 className="text-gray-600 text-lg font-semibold">Smith</h2>
									<span className="text-gray-500 text-sm">
										last seen yesterday
									</span>
								</div>
					...
					<div className="my-4 flex flex-col gap-y-4">
						<div className="rounded-md shadow-md border-t-2 border-sky-500">
							<div className="flex items-center p-2 tracking-wider">
								...
								/>
								<h2 className="mx-2 font-semibold text-gray-700">Steve</h2>
						...
						<div className="rounded-md shadow-md border-t-2 border-sky-500">
							<div className="flex items-center p-2 tracking-wider">
								<Image
									...
									className="border-b-2 border-sky-600 w-[2.4rem] h-[2.4rem] rounded-full object-cover"
								/>
								<h2 className="mx-2 font-semibold text-gray-700">Julia</h2>
						...
						<div className="rounded-md shadow-md border-t-2 border-sky-500">
							<div className="flex items-center p-2 tracking-wider">
								<Image
									...
									className="border-b-2 border-sky-600 w-[2.4rem] h-[2.4rem] rounded-full object-cover"
								/>
								<h2 className="mx-2 font-semibold text-gray-700">Alex</h2>
